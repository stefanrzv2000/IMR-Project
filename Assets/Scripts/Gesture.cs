...
public class Gesture : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        handProcessor = HTManager.instance.gameObject.GetComponent<ARHandProcessor>();
    ...
    public bool isPinch()
    {
        ...
        if (!isHigerThanReal(hands[4], 4, 8, 1))
        {
            return true;
        }
        return false;
    ...
    public bool isHigerThanReal(ARHand hand, int landmark1, int landmark2, float distance)
    {
        return (hand.GetLandmark(landmark1) - hand.GetLandmark(landmark2)).magnitude > distance;
    }
